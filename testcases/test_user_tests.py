...
class TestUserAPI:
    ...
    def test_create_user(self):
        ...
        response = requests.post(
            ...
            json=asdict(user_payload)         #useful in case of nested json
        )
        data = response.json()
        #print(json.dumps(data, indent=4))
    ...
    def test_update_user(self):
        ...
        assert data['name']['firstname'] == updated_user.name.firstname
        assert data['name']['lastname'] == updated_user.name.lastname
